            ...
            <Navbar className={classes.navHeader} collapseOnSelect expand="lg" bg="light" variant="light" fixed="top" style={{ zIndex: 1000 }}>
                ...
                <Nav className="me-auto">
                    <NavDropdown title="אזור אישי" id="collasible-nav-dropdown">
                        ...
                        <NavDropdown.Divider />
                        {/* onClick={toSignOut} */}
                        <NavDropdown.Item className={classes.dropdown}>התנתקות</NavDropdown.Item>
                    </NavDropdown>
                </Nav>
            </Navbar>
            <Switch>
                ...
                <Route component={StudentPayment} path="/studentPayment/:id" />
                ...
                <Route component={ViewPaymentNotice} path="/viewPaymentNotice/:id" />{/*הסדר תשלום */}
