...
export default function ViewPaymentNotice() {
    ...
    const footer = (
        <span>
            ...
            <Button style={{ backgroundColor: 'rgb(51 90 33)', color: 'white' }} label="לתשלום" icon="pi pi-check" className="p-button-text" onClick={() => history.push({ pathname: `/studentPayment/${id}` })} />
        </span>
    );
